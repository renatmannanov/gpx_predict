...
4. **Shared DB отвергнут:**
   - Два сервиса на одной БД = антипаттерн
   - Вместо этого: API между сервисами (ayda_run отдаёт токены)
...
#### Вариант A: Два сервиса, shared Postgres (рекомендуется)
