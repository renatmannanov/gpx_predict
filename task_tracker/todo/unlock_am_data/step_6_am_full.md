...
> Статус: [x] done — 6 AM-гонок залиты (id без _am_kz), фильтры убраны из
>   races.py/stats.py/types.ts, финальная пересборка 56 editions/0 errors.
>   Дубли клубов (7 пар sim>0.7) НЕ мёрджим — отдельная задача (ручной мёрдж клубов).
