...
Планы хранятся в `docs/task_tracker/todo/` — это единственный источник правды.

**Для небольших задач** (1-2 шага) — один файл:
```
docs/task_tracker/todo/fix_percentile.md
```

**Для больших фич** — папка с мейн-файлом и шагами:
```
docs/task_tracker/todo/compare_runners/
