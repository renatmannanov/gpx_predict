...
В итоге получается 11 категорий:
• Экстр. спуск (&lt;-23%)
• Крутой спуск (-23% до -17%)
• Умеренный спуск (-17% до -12%)
• Лёгкий спуск (-12% до -8%)
• Пологий спуск (-8% до -3%)
• Ровный участок (-3% до +3%)
• Пологий подъём (+3% до +8%)
• Лёгкий подъём (+8% до +12%)
• Умеренный подъём (+12% до +17%)
• Крутой подъём (+17% до +23%)
• Экстр. подъём (&gt;+23%)
"""
...
Я использую GAP (Grade Adjusted Pace) — формулу, похожую на ту, что в Strava, но со своими доработками:
...
В итоге получается 11 категорий рельефа:
• Экстр. спуск (&lt;-23%)
• Крутой спуск (-23% до -17%)
• Умеренный спуск (-17% до -12%)
• Лёгкий спуск (-12% до -8%)
