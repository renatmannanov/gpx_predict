...
class HikeFatigueService:
    ...
    def create_enabled(
        ...
        """
        Factory method to create an enabled HikeFatigueService.
        ...
        Returns:
            Configured and enabled HikeFatigueService
        """
        ...
        return HikeFatigueService(config)
...
FatigueService = HikeFatigueService
